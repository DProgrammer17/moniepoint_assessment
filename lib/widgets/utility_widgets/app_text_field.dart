...
import 'package:moniepoint_assessment/utils/textfeild_formatter/amount_formatter.dart';
import 'package:moniepoint_assessment/widgets/utility_widgets/keyboard_overlay.dart';
  ...
  Widget build(BuildContext context) {
    inputBorder = OutlineInputBorder(
      ...
      borderSide: BorderSide(
        color: widget.borderColor ?? AppColors.neutralWhite,
      ),
    );
    return Padding(
